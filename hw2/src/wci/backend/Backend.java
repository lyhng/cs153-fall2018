 ...
 * <h1>Backend</h1>
 *
 * <p>The framework class that represents the back end component.
 *
...
public abstract class Backend implements MessageProducer {
  ...
  /**
   * Process the intermediate code and the symbol table generated by the parser. To be implemented
   * by a compiler or an interpreter subclass.
   *
