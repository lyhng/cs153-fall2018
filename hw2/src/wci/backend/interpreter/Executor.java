...
public class Executor extends Backend {
  /**
   * Process the intermediate code and the symbol table generated by the parser to execute the
   * source program.
   *
  ...
  public void process(ICode iCode, SymTab symTab) throws Exception {
    ...
    sendMessage(
        new Message(
            INTERPRETER_SUMMARY, new Number[] {executionCount, runtimeErrors, elapsedTime}));
  }
}
