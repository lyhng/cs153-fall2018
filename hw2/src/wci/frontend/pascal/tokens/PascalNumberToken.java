 ...
 *
 * <p>Pascal number tokens (integer and real).
 *
...
public class PascalNumberToken extends PascalToken {
  ...
  /**
   * Compute and return the integer value of a string of digits. Check for overflow.
   *
  ...
  private float computeFloatValue(
      String wholeDigits, String fractionDigits, String exponentDigits, char exponentSign) {
