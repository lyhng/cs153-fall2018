 ...
 * <h1>Scanner</h1>
 *
 * <p>A language-independent framework class. This abstract scanner class will be implemented by
...
public abstract class Scanner {
  ...
  /**
   * Do the actual work of extracting and returning the next token from the source. Implemented by
   * scanner subclasses.
   *
   * @return the next token.
   * @throws Exception if an error occurred.
