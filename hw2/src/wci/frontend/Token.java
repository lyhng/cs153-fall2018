 ...
 * <h1>Token</h1>
 *
 * <p>The framework class that represents a token returned by the scanner.
 *
...
public class Token {
   ...
   * this method to construct language-specific tokens. After extracting the token, the current
