 ...
 * <h1>Parser</h1>
 *
 * <p>A language-independent framework class. This abstract parser class will be implemented by
...
public abstract class Parser implements MessageProducer {
  ...
  /**
   * Parse a source program and generate the intermediate code and the symbol table. To be
   * implemented by a language-specific parser subclass.
   *
  ...
  /**
   * Return the number of syntax errors found by the parser. To be implemented by a
